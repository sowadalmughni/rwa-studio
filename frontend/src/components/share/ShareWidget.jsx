            ...
            <TabsContent value="social" className="space-y-3 pt-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value={pageUrl} readOnly className="text-xs h-9" />
                  <Button
                    variant="outline"
                    size="sm"
                    className="shrink-0"
            ...
            <TabsContent value="embed" className="space-y-3 pt-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center p-4 bg-gray-50 rounded-lg">
                  <img src={badgeUrl} alt={`${tokenName} badge`} className="max-h-8" />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value={embedCodes.html} readOnly className="text-xs h-9 font-mono" />
                  <Button
                    variant="outline"
                    size="sm"
                    className="shrink-0"
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value={embedCodes.markdown} readOnly className="text-xs h-9 font-mono" />
                  <Button
                    variant="outline"
                    size="sm"
                    className="shrink-0"
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value={badgeUrl} readOnly className="text-xs h-9" />
                  <Button
                    variant="outline"
                    size="sm"
                    className="shrink-0"
